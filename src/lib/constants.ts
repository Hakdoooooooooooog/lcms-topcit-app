      ...
      },
      {
        ...
        deepSubLinks: [
          ...
          },
          {
            ...
            component: lazy(() => import("../pages/User/LearningHub/Resource Libraries")),
          },
        ],
      },
      {
        ...
        deepSubLinks: [
          {
            name: "Main",
            isIndex: true,
            component: lazy(() => import("../pages/User/ProgressTracker/MainPage")),
          },
          {
            name: "Contents",
            href: "contents",
            component: lazy(() => import("../pages/User/ProgressTracker/Contents")),
          },
          {
            name: "Assessments",
            href: "assessments",
            component: lazy(() => import("../pages/User/ProgressTracker/Assessments")),
          },
        ],
      },
      {
      ...
      },
      {
        ...
        deepSubLinks: [
          ...
          },
          {
            ...
            component: lazy(() => import("../pages/Others/Landing/Forgot-Password")),
          },
        ],
      },
      {
        ...
        deepSubLinks: [
          ...
          },
          {
            name: "Resource Library",
            href: "resource-library",
            component: lazy(() => import("../pages/Admin/AdminHub/ResourceLibrary")),
          },
        ],
      },
    ],
...
export const landingPaths = ["/landing", "/landing/register", "/landing/forgot-password"];
...
export const excludedSearchPaths = new Set(["/learning-hub", "/progress-tracker", "/admin"]);
